...
import type { Nuxt } from '@nuxt/types/nuxt'
import type { NuxtOptionsLoaders } from '@nuxt/types/config/build'
import type { NuxtRouteConfig } from '@nuxt/types/config/router'
import type { NuxtOptionsServerMiddleware } from '@nuxt/types/config/server-middleware'
